  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "radial-gradient(120% 100% at 80% 10%, rgba(198,120,92,.4), transparent 55%), linear-gradient(160deg,#2a1224,#3D1A33)",
        }}
      >
      ...
      <div className="relative z-10 mx-auto -mt-8 max-w-[720px] rounded-[18px] border border-[#eadfd4] bg-white px-7 py-[26px] shadow-[0_14px_40px_rgba(61,26,51,0.08)]">
